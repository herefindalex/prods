...
const installerText = {
  "en-US": {
    ...
    sampleData: "Install the sample data included with this Prods version", sampleAvailable: "Compiled into and verified for this exact Prods version. No download is required.",
    sampleUnavailable: "The built-in sample data does not match this build. You can still complete an empty installation.",
  ...
  "zh-TW": {
    ...
    sampleData: "安裝此 Prods 版本內建的 sample data", sampleAvailable: "資料已編譯進此 Prods 版本並完成驗證，不需要下載。",
    sampleUnavailable: "內建 sample data 與此 build 不相符；仍可完成空白安裝。",
...
const sampleInstallerText: Record<SystemLocale, Pick<TextOf<(typeof installerText)["en-US"]>, "sampleData" | "sampleAvailable" | "sampleUnavailable">> = {
  "en-US": { sampleData: "Install the sample data included with this Prods version", sampleAvailable: "Compiled into and verified for this exact Prods version. No download is required.", sampleUnavailable: "The built-in sample data does not match this build. You can still complete an empty installation." },
  "zh-TW": { sampleData: "安裝此 Prods 版本內建的 sample data", sampleAvailable: "資料已編譯進此 Prods 版本並完成驗證，不需要下載。", sampleUnavailable: "內建 sample data 與此 build 不相符；仍可完成空白安裝。" },
  "zh-CN": { sampleData: "安装此 Prods 版本内置的示例数据", sampleAvailable: "数据已编译到此 Prods 版本并完成验证，无需下载。", sampleUnavailable: "内置示例数据与此 build 不匹配；仍可完成空白安装。" },
  "ja-JP": { sampleData: "この Prods バージョンに含まれるサンプルデータをインストール", sampleAvailable: "この Prods バージョン専用に組み込まれ、検証済みです。ダウンロードは不要です。", sampleUnavailable: "内蔵サンプルデータがこの build と一致しません。空の状態でインストールできます。" },
  "ko-KR": { sampleData: "이 Prods 버전에 포함된 샘플 데이터 설치", sampleAvailable: "이 Prods 버전에 맞게 컴파일되고 검증되었습니다. 다운로드가 필요하지 않습니다.", sampleUnavailable: "내장 샘플 데이터가 이 build와 일치하지 않습니다. 빈 설치는 계속할 수 있습니다." },
  "de-DE": { sampleData: "Die in dieser Prods-Version enthaltenen Beispieldaten installieren", sampleAvailable: "Für genau diese Prods-Version kompiliert und geprüft. Kein Download erforderlich.", sampleUnavailable: "Die integrierten Beispieldaten passen nicht zu diesem Build. Eine leere Installation ist weiterhin möglich." },
  "fr-FR": { sampleData: "Installer les données d’exemple incluses dans cette version de Prods", sampleAvailable: "Compilées et vérifiées pour cette version exacte de Prods. Aucun téléchargement requis.", sampleUnavailable: "Les données d’exemple intégrées ne correspondent pas à ce build. Une installation vide reste possible." },
  "it-IT": { sampleData: "Installa i dati di esempio inclusi in questa versione di Prods", sampleAvailable: "Compilati e verificati per questa versione esatta di Prods. Non è richiesto alcun download.", sampleUnavailable: "I dati di esempio integrati non corrispondono a questa build. Puoi comunque completare un’installazione vuota." },
  "es-ES": { sampleData: "Instalar los datos de ejemplo incluidos en esta versión de Prods", sampleAvailable: "Compilados y verificados para esta versión exacta de Prods. No se requiere descarga.", sampleUnavailable: "Los datos de ejemplo integrados no coinciden con esta compilación. Puedes completar una instalación vacía." },
  "pt-BR": { sampleData: "Instalar os dados de exemplo incluídos nesta versão do Prods", sampleAvailable: "Compilados e verificados para esta versão exata do Prods. Nenhum download é necessário.", sampleUnavailable: "Os dados de exemplo integrados não correspondem a esta build. Ainda é possível concluir uma instalação vazia." },
};
