...
func (s *Server) routes(static fs.FS) {
	...
	s.mux.HandleFunc("GET /admin/api/system/runtime-log/text", s.adminRuntimeLogText)
	...
	s.mux.HandleFunc("POST /admin/api/product-bulk/preflight", s.adminPrepareProductBulk)
	s.mux.HandleFunc("GET /admin/api/product-bulk/{id}", s.adminProductBulk)
	s.mux.HandleFunc("POST /admin/api/product-bulk/{id}/execute", s.adminExecuteProductBulk)
