...
var officialCopyFields = []officialCopyField{
	...
	{"search.filters", "Public filter-panel label", func(m Messages) string { return m.Filters }},
	{"search.clear_filters", "Public clear-filters action", func(m Messages) string { return m.ClearFilters }},
	...
	{"product.select_for_rfq", "Public Product RFQ selection label", func(m Messages) string { return m.SelectForRFQ }},
	{"product.selected_products", "Public selected-products tray label", func(m Messages) string { return m.SelectedProducts }},
	{"product.clear_selection", "Public RFQ clear-selection action", func(m Messages) string { return m.ClearSelection }},
	{"product.more_details", "Public mobile-row expand action", func(m Messages) string { return m.MoreDetails }},
	{"product.less_details", "Public mobile-row collapse action", func(m Messages) string { return m.LessDetails }},
...
func ApplyPublicCopy(messages Messages, values map[string]string) Messages {
	targets := map[string]*string{
		...
		"search.filters": &messages.Filters, "search.clear_filters": &messages.ClearFilters,
		...
		"product.select_for_rfq": &messages.SelectForRFQ, "product.selected_products": &messages.SelectedProducts,
		"product.clear_selection": &messages.ClearSelection, "product.more_details": &messages.MoreDetails,
		"product.less_details": &messages.LessDetails,
